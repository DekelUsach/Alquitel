# 🏢 Alquitel - Guía Técnica y Arquitectura del Sistema (AGENTS.md)

Este archivo sirve como referencia completa y mapa de navegación para la IA (**Codex** u otras herramientas de desarrollo), describiendo detalladamente la arquitectura, las entidades, el flujo de datos y el funcionamiento interno del software de gestión corporativa y documental de **Alquitel**.
